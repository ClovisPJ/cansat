...
int main() {
  ...
  while(1) {
    ...
    FILE *f;
    f = fopen("acc0", "w"); fprintf(f, "%f\n", pck.acc[0]); fclose(f);
    f = fopen("acc1", "w"); fprintf(f, "%f\n", pck.acc[1]); fclose(f);
    f = fopen("acc2", "w"); fprintf(f, "%f\n", pck.acc[2]); fclose(f);
    f = fopen("scale", "w"); fprintf(f, "%d\n", pck.scale); fclose(f);
    f = fopen("pressure", "w"); fprintf(f, "%d\n", pck.pressure); fclose(f);
    f = fopen("temperature1", "w"); fprintf(f, "%f\n", pck.temperature1); fclose(f);
    f = fopen("altitude1", "w"); fprintf(f, "%f\n", pck.altitude1); fclose(f);
    f = fopen("sealevel", "w"); fprintf(f, "%d\n", pck.sealevel); fclose(f);
    f = fopen("humidity", "w"); fprintf(f, "%f\n", pck.humidity); fclose(f);
    f = fopen("temperature2", "w"); fprintf(f, "%f\n", pck.temperature2); fclose(f);
    f = fopen("compRH", "w"); fprintf(f, "%f\n", pck.compRH); fclose(f);
    f = fopen("time", "w");
    ...
    f = fopen("location0", "w"); fprintf(f, "%f\n", gsl_vector_get(&pck.location,0)); fclose(f);
    f = fopen("location1", "w"); fprintf(f, "%f\n", gsl_vector_get(&pck.location,1)); fclose(f);
    f = fopen("speed", "w"); fprintf(f, "%f\n", pck.speed); fclose(f);
    f = fopen("course", "w"); fprintf(f, "%f\n", pck.course); fclose(f);
    f = fopen("fix_quality", "w"); fprintf(f, "%d\n", pck.fix_quality); fclose(f);
    f = fopen("satelites", "w"); fprintf(f, "%d\n", pck.satelites); fclose(f);
    f = fopen("hdop", "w"); fprintf(f, "%f\n", pck.hdop); fclose(f);
    f = fopen("altitude2", "w"); fprintf(f, "%f\n", pck.altitude2); fclose(f);
    f = fopen("ellipsoid_seperation", "w"); fprintf(f, "%f\n", pck.ellipsoid_seperation); fclose(f);
